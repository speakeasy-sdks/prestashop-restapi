...
export class Address {
  ...
  async deleteRestAddress(
    ...
    const res: operations.DeleteRestAddressResponse =
      new operations.DeleteRestAddressResponse({
  ...
  async getRestAddress(
    ...
    const res: operations.GetRestAddressResponse =
      new operations.GetRestAddressResponse({
        statusCode: httpRes.status,
        contentType: contentType,
        rawResponse: httpRes,
      });
  ...
  async postRestAddress(
    ...
    const res: operations.PostRestAddressResponse =
      new operations.PostRestAddressResponse({
        statusCode: httpRes.status,
        contentType: contentType,
        rawResponse: httpRes,
      });
